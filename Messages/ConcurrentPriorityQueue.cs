...
{
    /// <summary>Provides a thread-safe priority queueBuffer data structure.</summary>
    /// <typeparam name="TKey">Specifies the type of keys used to prioritize values.</typeparam>
    /// <typeparam name="TValue">Specifies the type of elements in the queueBuffer.</typeparam>
    [DebuggerDisplay("Count={Count}")]
    public class ConcurrentPriorityQueue<TKey, TValue> :
        IProducerConsumerCollection<KeyValuePair<TKey, TValue>> where TKey : IComparable<TKey>
    {
        ...
        /// <summary>Adds the key/value pair to the priority queueBuffer.</summary>
        ...
        /// <summary>Adds the key/value pair to the priority queueBuffer.</summary>
        /// <param name="item">The key/value pair to be added to the queueBuffer.</param>
        public void Enqueue(KeyValuePair<TKey, TValue> item)
        {
            lock (_syncLock) _minHeap.Insert(item);
        }

        /// <summary>Attempts to remove and return the next prioritized item in the queueBuffer.</summary>
        /// <param name="result">
        ...
        /// </param>
        /// <returns>
        /// true if an element was removed and returned from the queueBuffer succesfully; otherwise, false.
        /// </returns>
        ...
        /// <summary>Attempts to return the next prioritized item in the queueBuffer.</summary>
        /// <param name="result">
        /// When this method returns, if the operation was successful, result contains the object.
        /// The queueBuffer was not modified by the operation.
        /// </param>
        /// <returns>
        /// true if an element was returned from the queueBuffer succesfully; otherwise, false.
        /// </returns>
        ...
        /// <summary>Empties the queueBuffer.</summary>
        public void Clear() { lock (_syncLock) _minHeap.Clear(); }

        /// <summary>Gets whether the queueBuffer is empty.</summary>
        public bool IsEmpty { get { return Count == 0; } }

        /// <summary>Gets the number of elements contained in the queueBuffer.</summary>
        public int Count
        {
        ...
        /// <param name="array">
        /// The one-dimensional array that is the ServiceDestination of the elements copied from the queueBuffer.
        /// </param>
        /// <param name="index">
        ...
        /// <summary>Copies the elements stored in the queueBuffer to a new array.</summary>
        /// <returns>A new array containing a snapshot of elements copied from the queueBuffer.</returns>
        ...
        /// <summary>Attempts to add an item in the queueBuffer.</summary>
        ...
        /// <returns>An enumerator for the contents of the queueBuffer.</returns>
        /// <remarks>
        /// The enumeration represents a moment-in-time snapshot of the contents of the queueBuffer. It does not
        /// reflect any updates to the collection after GetEnumerator was called. The enumerator is safe to
        /// use concurrently with reads from and writes to the queueBuffer.
        /// </remarks>
